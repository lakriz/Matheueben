...
import Subtraction100Exercise from './Subtraction100Exercise';
...
function buildSession(): ExerciseData[] {
  ...
  while (subtractions.length < 12) {
    ...
    subtractions.push({
      ...
      choices: generateChoices(correct, Math.max(0, correct - 10), Math.min(100, correct + 10)),
    });
  }
