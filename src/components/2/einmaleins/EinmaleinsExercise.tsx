...
export default function EinmaleinsExercise({
  num1,
  num2,
  correctAnswer,
  choices,
  ...
  return (
    <div className="flex flex-col items-center gap-8 p-4">
      ...
      <div className="bg-white rounded-3xl shadow-lg px-10 py-8 flex items-center gap-4">
        <span className="text-7xl md:text-8xl font-black text-rose-700">{num1}</span>
        <span className="text-6xl md:text-7xl font-black text-pink-500">×</span>
        <span className="text-7xl md:text-8xl font-black text-rose-700">{num2}</span>
