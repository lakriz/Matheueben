...
import Subtraction1000Exercise from './Subtraction1000Exercise';
...
function buildSession(): ExerciseData[] {
  ...
  // 12 subtraction problems (grade 3: num1 up to 1000, num2 ≤ num1)
  const subtractions: SubtractionData[] = [];
  while (subtractions.length < 12) {
    const num1 = rand(100, 1000);
    const num2 = rand(10, num1);
    ...
    subtractions.push({
      ...
      choices: generateChoices(correct, Math.max(0, correct - 50), correct + 50),
    });
  }
